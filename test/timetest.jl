...
# @benchmarkable mfd = random_big_timeseries_mfd(;ninstances=10000, nattr=600, ts_len=100);
...
# bm, fr_bm = @benchmarkable  SoleFeatures.build_bitmask(nmfd, frame_num, vt) setup=(mfd = random_big_timeseries_mfd(;ninstances=10000, nattr=300, ts_len=100);)
...
mfd = random_big_timeseries_mfd(;ninstances=ninstances, nattr=nattr, ts_len=ts_len)
